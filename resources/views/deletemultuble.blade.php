...
<div class="container mt-4">
  ...
  <form method="POST" action="{{url('employee/deletemore')}}">
              ...
              <div class="item-box-blog-body">
                ...
                <div class="item-box-blog-heading">
                    ...
                    <h5>{{$emp->name}}
                            @csrf
                            @method("delete")
                     <input type="hidden" value="{{$emp->name}}" name="name[]">
                     <input type="hidden" value="{{$emp->img}}" name="img[]">
                    <input type="checkbox" value="{{$emp->id}}" name="id[]"></h5>
